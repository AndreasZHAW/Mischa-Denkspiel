...
const STRINGS = {
  ...
  'zoo.shoe_red_desc':     { de:'Erhöhen deine Laufgeschwindigkeit dauerhaft um 20%. Einmal gekauft, für immer aktiv — keine erneute Nutzung nötig.',
                             ...
                             fr:'Augmentent définitivement ta vitesse de déplacement de 20 %. Achète-les une fois, elles restent actives pour toujours.' , it:'Aumentano permanentemente la tua velocità di camminata del 20%. Acquistale una volta, restano attive per sempre — non serve riutilizzarle.'},
  ...
  'zoo.shoe_gold_desc':    { de:'Erhöhen deine Laufgeschwindigkeit dauerhaft um 50% — die stärkere Wahl. Einmal gekauft, für immer aktiv. Wirkt nicht zusätzlich zu den roten Turnschuhen (kein Stapeln), ersetzt sie aber.',
                             ...
                             fr:'Augmentent définitivement ta vitesse de déplacement de 50 % — la meilleure option. Achète-les une fois, elles restent actives pour toujours. Ne se cumulent pas avec les baskets rouges, mais les remplacent.' , it:'Aumentano permanentemente la tua velocità di camminata del 50% — l\'opzione più potente. Acquistale una volta, restano attive per sempre. Non si sommano alle scarpe rosse, ma le sostituiscono.'},
  ...
  'zoo.shopinfo_rebirth_desc': { de:'Setzt fast deinen ganzen Zoo zurück (MT, fast alle Tiere) — dafür bekommst du einen dauerhaften Einnahmen-Bonus, der für immer bleibt, auch nach der nächsten Rinascita. Je öfter du wiedergeboren wirst, desto mehr MT brauchst du für die nächste Stufe, aber desto grösser der Bonus.',
                             en:'Resets almost your entire zoo (MT, almost all animals) — in exchange you get a permanent income bonus that stays forever, even through your next rebirth. Each rebirth needs more MT than the last, but gives a bigger bonus.',
                             fr:'Réinitialise presque tout ton zoo (MT, presque tous les animaux) — en échange, tu obtiens un bonus de revenus permanent qui reste pour toujours, même après ta prochaine renaissance. Chaque renaissance demande plus de MT que la précédente, mais offre un bonus plus important.',
                             it:'Azzera quasi tutto il tuo zoo (MT, quasi tutti gli animali) — in cambio ottieni un bonus di guadagno permanente che resta per sempre, anche dopo la prossima rinascita. Ogni rinascita richiede più MT della precedente, ma offre un bonus maggiore.' },
