...
const GAME_LIST = [
  ...
  { id:'simon2',     name:'Bomber',         icon:'💣', type:'pacman',     baseReward:1.5, desc:'Zerstöre alle Geister mit deinen Bomben!' },
  { id:'math2',      name:'Schleuder',      icon:'🥐', type:'catapult',   baseReward:1.5, desc:'Ziele mit der Schleuder auf Croissants & Baguettes!' },
...
const WORLD_DEFS = [
  {id:1, name:'Welt 1', get subtitle(){ return (typeof t!=='undefined'?t('world1.subtitle'):'Reise nach Frankreich'); }, icon:'🇫🇷', color:'#2980B9',
   ...
   tasks:[
    ...
    {id:'simon2',     type:'pacman',      name:'Bomber',       icon:'💣', title:'Bomber'},
    {id:'math2',      type:'catapult',   name:'Schleuder',     icon:'🥐', title:'Croissant-Schleuder'},
