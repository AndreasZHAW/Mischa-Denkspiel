...
const FontScale = {
  ...
  load(playerName) {
    ...
    try{
      if(localStorage.getItem('mischa_fontscale_reset_v245')!=='1'){
        ...
        localStorage.setItem('mischa_fontscale_reset_v245','1');
      }
    }catch(e){}
    try {
    ...
    this._html(`
      ...
      <div class="page">
        <div class="game-logo">
          ...
          <p style="font-size:var(--fs-sm);color:rgba(255,255,255,.4);margin-top:2px;letter-spacing:.5px">📦 v245 · 2026-05-24</p>
        </div>
