...
const STRINGS = {
  // ── WELCOME PAGE ──
  'welcome.title':         { de:'Yo, willkommen, Abenteurer!', de_simple:'Willkommen, Abenteurer', en:'Welcome, Adventurer', fr:'Bienvenue, Aventurier' },
  'welcome.subtitle':      { de:'2 Welten · Verdien dir 🌀 MT · Bau deinen Zoo — richtig krass!', de_simple:'2 Welten · Verdiene 🌀 MT · Baue deinen Zoo!', en:'2 Worlds · Earn 🌀 MT · Build your Zoo!', fr:'2 Mondes · Gagne 🌀 MT · Construis ton Zoo!' },
  ...
  'zoo.profile':           { de:'Profil', en:'Profile', fr:'Profil' },
  'zoo.report':            { de:'Melden', en:'Report', fr:'Signaler' },
  'zoo.reward':            { de:'Belohnung', en:'Reward', fr:'Récompense' },
  'zoo.gondola_station':   { de:'🚡 Gondel-Station', en:'🚡 Gondola Station', fr:'🚡 Station de gondole' },
  'zoo.next':              { de:'Nächste:', en:'Next:', fr:'Prochain :' },
  'zoo.more_luck':         { de:'🍀 Mehr Glück:', en:'🍀 More luck:', fr:'🍀 Plus de chance :' },
  'zoo.all_animals_rarity':{ de:'📋 Alle Tiere nach Seltenheit', en:'📋 All animals by rarity', fr:'📋 Tous les animaux par rareté' },
  'zoo.buy':               { de:'Kaufen', en:'Buy', fr:'Acheter' },
  'zoo.rarity_normal':     { de:'Normal', en:'Common', fr:'Normal' },
  'zoo.rarity_rare':       { de:'Selten', en:'Rare', fr:'Rare' },
  'zoo.rarity_epic':       { de:'Episch', en:'Epic', fr:'Épique' },
  'zoo.rarity_legendary':  { de:'Legendär', en:'Legendary', fr:'Légendaire' },
  'zoo.rarity_mythic':     { de:'Mythisch', en:'Mythic', fr:'Mythique' },
  ...
  'zoo.popular_desc':      { de:'100 Besucher in deinem Zoo! +100 MT!', en:'100 visitors in your zoo! +100 MT!', fr:'100 visiteurs dans ton zoo ! +100 MT !' },
  'zoo.tiktok_event':      { de:'Unseriöse TikToker haben sich als Tierschützer ausgegeben und in allen Zoobereichen das wertvollste Tier freigelassen. Schnell Tiere suchen und wieder einfangen!',
                             ...
                             fr:'De faux défenseurs des animaux sur TikTok ont libéré l’animal le plus précieux de chaque zone du zoo. Vite, retrouve-les et rattrape-les !' },
  'zoo.shoe_red_title':    { de:'👟 Rote Turnschuhe', en:'👟 Red Sneakers', fr:'👟 Baskets rouges' },
  'zoo.shoe_red_desc':     { de:'Erhöhen deine Laufgeschwindigkeit dauerhaft um 20%. Einmal gekauft, für immer aktiv — keine erneute Nutzung nötig.',
                             de_simple:'Machen dich dauerhaft 20% schneller beim Laufen. Einmal kaufen, für immer da.',
                             en:'Permanently increase your walking speed by 20%. Buy once, active forever — no need to use it again.',
                             fr:'Augmentent définitivement ta vitesse de déplacement de 20 %. Achète-les une fois, elles restent actives pour toujours.' },
  'zoo.shoe_gold_title':   { de:'✨ Goldene Turnschuhe', en:'✨ Golden Sneakers', fr:'✨ Baskets dorées' },
  'zoo.shoe_gold_desc':    { de:'Erhöhen deine Laufgeschwindigkeit dauerhaft um 50% — die stärkere Wahl. Einmal gekauft, für immer aktiv. Wirkt nicht zusätzlich zu den roten Turnschuhen (kein Stapeln), ersetzt sie aber.',
                             de_simple:'Machen dich dauerhaft 50% schneller beim Laufen — noch besser als die roten. Einmal kaufen, für immer da.',
                             en:'Permanently increase your walking speed by 50% — the stronger option. Buy once, active forever. Doesn\'t stack with the red sneakers, but replaces them.',
                             fr:'Augmentent définitivement ta vitesse de déplacement de 50 % — la meilleure option. Achète-les une fois, elles restent actives pour toujours. Ne se cumulent pas avec les baskets rouges, mais les remplacent.' },
  ...
  'zoo.gondola_locked_police': { de:'🚓🔒 Gondel gesperrt!', en:'🚓🔒 Gondola locked!', fr:'🚓🔒 Gondole bloquée !' },
  'zoo.police_raid':       { de:'Polizei-Razzia · noch {n} Min', en:'Police raid · {n} min left', fr:'Descente de police · encore {n} min' },
  'zoo.open_after_buy':    { de:'🥚 Sofort öffnen nach Kauf!', en:'🥚 Opens instantly after buying!', fr:'🥚 S\'ouvre tout de suite après achat !' },
  'zoo.too_little':        { de:'❌ Zu wenig', en:'❌ Not enough', fr:'❌ Pas assez' },
  'zoo.buy_and_open':      { de:'🥚 Kaufen & Öffnen!', en:'🥚 Buy & Open!', fr:'🥚 Acheter et ouvrir !' },
  'zoo.buy_cart':          { de:'🛒 Kaufen', en:'🛒 Buy', fr:'🛒 Acheter' },
  'zoo.gondola_locked_toast': { de:'🚓 Gondel gesperrt (Polizei)! Noch {n} Min', en:'🚓 Gondola locked (police)! {n} min left', fr:'🚓 Gondole bloquée (police) ! Encore {n} min' },
  'zoo.all_enc_full':      { de:'❌ Alle Gehege belegt!', en:'❌ All enclosures full!', fr:'❌ Tous les enclos sont pleins !' },
  'zoo.too_little_mt':     { de:'❌ Zu wenig MT!', en:'❌ Not enough MT!', fr:'❌ Pas assez de MT !' },
  ...
  'wm.teleport_btn':       { de:'🚀 In den Zoo teleportieren! (15 🌀 MT)', en:'🚀 Teleport to the Zoo! (15 🌀 MT)', fr:'🚀 Téléporter au Zoo ! (15 🌀 MT)' },
  ...
  'welcome.world2.body1':   { de:'Teleportiere für <b>15 MT</b> 🌀 in den Zoo.', en:'Teleport to the Zoo for <b>15 MT</b> 🌀.', fr:'Téléporte-toi au Zoo pour <b>15 MT</b> 🌀.' },
  ...
  'intro.next':            { de:'Weiter ›', de_simple:'Weiter ›', en:'Next ›', fr:'Suivant ›' },
  'intro.ch0.label':       { de:'Prolog', de_simple:'Prolog', en:'Prologue', fr:'Prologue' },
  'intro.ch0.title':       { de:'Irgendwo in der Welt...', de_simple:'Irgendwo in der Welt...', en:'Somewhere in the world...', fr:'Quelque part dans le monde...' },
  ...
  'intro.ch1.label':       { de:'Die Helden', de_simple:'Die Helden', en:'The Heroes', fr:'Les Héros' },
  ...
  'intro.ch1.janosch_desc':{ de:'Der Starke. Schnell, ehrgeizig, mit Herz — absoluter Main Character.', de_simple:'Der Starke. Schnell, ehrgeizig, mit Herz.', en:'The Strong One. Fast, ambitious, with heart.', fr:'Le Fort. Rapide, ambitieux, avec du cœur.' },
  ...
  'intro.ch2.label':       { de:'Die Herausforderung', de_simple:'Die Herausforderung', en:'The Challenge', fr:'Le Défi' },
  'intro.ch2.title':       { de:'Erkämpfe dein Startkapital', de_simple:'Erkämpfe dein Startkapital', en:'Earn your starting capital', fr:'Gagne ton capital de départ' },
  ...
  'intro.ch3.label':       { de:'Der Traum', de_simple:'Der Traum', en:'The Dream', fr:'Le Rêve' },
  'intro.ch3.title':       { de:'Baue deinen eigenen Zoo', de_simple:'Baue deinen eigenen Zoo', en:'Build your own zoo', fr:'Construis ton propre zoo' },
  ...
  'intro.ch4.label':       { de:'Zusammen stärker', de_simple:'Zusammen stärker', en:'Stronger together', fr:'Plus forts ensemble' },
  'intro.ch4.title':       { de:'Du bist nicht allein', de_simple:'Du bist nicht allein', en:'You are not alone', fr:'Tu n\'es pas seul' },
  ...
  'intro.ch5.label':       { de:'Deine Geschichte beginnt', de_simple:'Deine Geschichte beginnt', en:'Your story begins', fr:'Ton histoire commence' },
  'intro.ch5.title':       { de:'Bist du bereit?', de_simple:'Bist du bereit?', en:'Are you ready?', fr:'Es-tu prêt ?' },
  'intro.ch5.text':        { de:'Die Reise startet.<br>Lös die Rätsel. Bau den Zoo.<br><br><b>Werde Teil von was richtig Grossem.</b><br><br>⏳ <b>Heads up:</b> Das Ganze läuft nur bis zum <b>{deadline}</b> — wer dann oben steht, hat gewonnen. No cap!',
                              ...
                              fr:'Le voyage commence.<br>Résous les énigmes. Construis le zoo.<br><br><b>Fais partie de quelque chose de grand.</b><br><br>⏳ <b>Attention :</b> L\'aventure ne dure que jusqu\'au <b>{deadline}</b> — celui qui sera en tête à ce moment-là gagne !' },
  'intro.ch5.btn':         { de:'🚀 Auf geht\'s, Bro!', de_simple:'🚀 Abenteuer starten', en:'🚀 Start Adventure', fr:'🚀 Démarrer l\'Aventure' },
  'intro.end.sub':         { de:'+ Zoo 3D · Das Abenteuer', de_simple:'+ Zoo 3D · Das Abenteuer', en:'+ Zoo 3D · The Adventure', fr:'+ Zoo 3D · L\'Aventure' },
  'intro.end.btn':         { de:'▶ Jetzt spielen', de_simple:'▶ Jetzt spielen', en:'▶ Play Now', fr:'▶ Jouer Maintenant' },
  ...
  'instr.catapult':    { de:'🥐 <b>Croissant-Schleuder!</b><br>Ziehe die Schleuder zurück und lass los, um zu schiessen! Triff die Croissants 🥐 und Baguettes 🥖 — bewegte Ziele bringen mehr Punkte als stehende. Du hast 10 Schüsse.<br>📱 Mobile: mit dem Finger ziehen<br>🖥️ Desktop: mit der Maus ziehen',
    ...
    fr:'🥐 <b>Catapulte à croissants !</b><br>Tire sur la fronde et relâche pour tirer ! Touche les croissants 🥐 et les baguettes 🥖 — les cibles en mouvement rapportent plus de points que les fixes. Tu as 10 tirs.<br>📱 Mobile : fais glisser avec le doigt<br>🖥️ Ordinateur : fais glisser avec la souris' },
